...
export function pickedUpTemplate(data: ShipmentEmailData): EmailTemplate {
...
<body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="border: 1px solid #e5e7eb; border-top: none; padding: 20px; border-radius: 0 0 8px 8px;">
    ...
    <p>Your shipment <strong>${data.trackingId}</strong> has been picked up${locationLine}${carrierLine}.</p>
    ...
    <a href="#" style="display: inline-block; background: #2563EB; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px;">Track Your Shipment</a>
  </div>
