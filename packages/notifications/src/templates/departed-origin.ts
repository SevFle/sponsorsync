...
export function departedOriginTemplate(data: ShipmentEmailData): EmailTemplate {
...
<body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: #7C3AED; color: white; padding: 20px; border-radius: 8px 8px 0 0; text-align: center;">
    <h1 style="margin: 0;">Departed Origin</h1>
  </div>
  <div style="border: 1px solid #e5e7eb; border-top: none; padding: 20px; border-radius: 0 0 8px 8px;">
    <p>${customerGreeting}</p>
    <p>Your shipment <strong>${data.trackingId}</strong> has departed the origin${locationLine}${carrierLine}.</p>
    ...
    <a href="#" style="display: inline-block; background: #7C3AED; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px;">Track Your Shipment</a>
  </div>
